...
img = pygame.image.load('imagens.py/ng.png')

alien = pygame.image.load('imagens.py/aliensp.png').convert_alpha()
alien = pygame.transform.scale(alien, (60,50))


playerimg = pygame.image.load('imagens.py/nave.png').convert_alpha()
playerimg = pygame.transform.scale(playerimg, (50,50)) #tamanho da nave
playerimg = pygame.transform.rotate(playerimg, -90)

missil = pygame.image.load('imagens.py/missile.png').convert_alpha()
...
font = pygame.font.SysFont('imagens.py/m23.TTF', 50)
